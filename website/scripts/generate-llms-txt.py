...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Using Hermes", [
        ...
        ("user-guide/desktop", "Desktop App", None),
        ("user-guide/bot-mode", "Bot Mode", None),
    ...
    ("Core Features", [
        ...
        ("user-guide/features/tool-gateway", "Nous Tool Gateway", None),
        ("user-guide/features/document-extraction", "Document Extraction", None),
        ("user-guide/features/tool-search", "Tool Search", None),
        ("user-guide/features/skills", "Skills System", None),
        ("user-guide/features/lsp", "LSP — Semantic Diagnostics", None),
        ...
        ("user-guide/features/mixture-of-agents", "Mixture of Agents", None),
        ("user-guide/features/personality", "Personality & SOUL.md", None),
        ("user-guide/features/skins", "Skins & Themes", None),
    ...
    ("Automation", [
        ...
        ("user-guide/features/kanban-worker-lanes", "Kanban Worker Lanes", None),
        ("user-guide/features/goals", "Persistent Goals", None),
        ("user-guide/features/heartbeat", "Session Heartbeats", None),
        ("user-guide/features/loops", "Recurring Loops", None),
        ...
        ("user-guide/features/codex-app-server-runtime", "Codex App-Server Runtime", None),
    ]),
    ("Media & Web", [
        ("user-guide/features/voice-mode", "Voice Mode", None),
        ("user-guide/features/wake-word", "Wake Word", None),
        ...
        ("user-guide/features/computer-use", "Computer Use", None),
        ("user-guide/features/vision", "Vision", None),
        ("user-guide/features/image-generation", "Image Generation", None),
        ("user-guide/features/spotify", "Spotify", None),
        ("user-guide/features/pets", "Pets", None),
        ("user-guide/features/tts", "Text-to-Speech", None),
        ("user-guide/features/deliverable-mode", "Deliverable Mode", None),
    ]),
    ("Messaging Platforms", [
    ...
    ("Integrations", [
        ...
        ("user-guide/features/web-dashboard", "Web Dashboard", None),
        ("user-guide/features/extending-the-dashboard", "Extending the Dashboard", None),
        ("user-guide/features/subscription-proxy", "Subscription Proxy", None),
